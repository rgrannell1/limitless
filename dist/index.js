...
(() => {
  ...
  var Oo = (() => {
    ...
    return (n) => {
      for (
        ...
        var m = t18[n.charCodeAt(s++)],
          u = t18[n.charCodeAt(s++)],
          c = t18[n.charCodeAt(s++)],
          p = t18[n.charCodeAt(s++)];
  ...
  function I(...t18) {
    ...
    if (t18.length === 1) {
      ...
      if (Array.isArray(t18[0]) && t18[0].length === 3) {
        return j.fromArray(t18[0]);
      }
    } else if (t18.length === 2) {
      if (t18[0] instanceof j) return t18[0].clone();
    } else if (t18.length === 3 || t18.length === 4) {
      return new j(t18[0], t18[1], t18[2]);
    }
  ...
  function de(t18, e, n) {
    ...
    throw new Error(
      `Bad value for lerp(): ${t18}, ${e}. Only number, Vec2 and Color is supported.`,
    );
  }
  ...
  var E = class t2 {
    ...
    slerp(e, n) {
      ...
      return this.scale(Math.sin((1 - n) * s)).add(e.scale(Math.sin(n * s)))
        .scale(1 / o);
    }
    isZero() {
  ...
  var Dt = class t4 {
    ...
    eigenvectors(e, n) {
      return this.c != 0
        ? [[e - this.d, this.c], [n - this.d, this.c]]
        : this.b != 0
        ? [[this.b, e - this.a], [this.b, n - this.a]]
  ...
  var bt = class t5 {
    ...
    rotate(e) {
      ...
      return this.m11 = n * this.m11 + r * this.m21,
  ...
  var fe = class t6 {
    ...
    mult(e) {
      ...
      for (let r = 0; r < 4; r++) {
        for (let o = 0; o < 4; o++) {
          n[r * 4 + o] = this.m[0 * 4 + o] * e.m[r * 4 + 0] +
    ...
    invert() {
      ...
      let V = this.m[0] * e[0] + this.m[1] * e[4] + this.m[2] * e[8] +
        this.m[3] * e[12];
      for (let x = 0; x < 4; x++) {
  ...
  function Tr(t18, e) {
    return t18.pos.x + t18.width > e.pos.x && t18.pos.x < e.pos.x + e.width &&
      t18.pos.y + t18.height > e.pos.y && t18.pos.y < e.pos.y + e.height;
  }
  function ru(t18, e) {
    if (
      t18.p1.x === t18.p2.x && t18.p1.y === t18.p2.y ||
      e.p1.x === e.p2.x && e.p1.y === e.p2.y
    ) return null;
    let n = (e.p2.y - e.p1.y) * (t18.p2.x - t18.p1.x) -
      (e.p2.x - e.p1.x) * (t18.p2.y - t18.p1.y);
    if (n === 0) return null;
    let r = ((e.p2.x - e.p1.x) * (t18.p1.y - e.p1.y) -
        (e.p2.y - e.p1.y) * (t18.p1.x - e.p1.x)) / n,
      o = ((t18.p2.x - t18.p1.x) * (t18.p1.y - e.p1.y) -
        (t18.p2.y - t18.p1.y) * (t18.p1.x - e.p1.x)) / n;
  ...
  function Sn(t18, e) {
    ...
    return n
      ? v(
        t18.p1.x + n * (t18.p2.x - t18.p1.x),
        t18.p1.y + n * (t18.p2.y - t18.p1.y),
      )
      : null;
  }
  function Vn(t18, e) {
    ...
    if (n.x != 0) {
      let s = (t18.pos.x - e.p1.x) / n.x,
        i = (t18.pos.x + t18.width - e.p1.x) / n.x;
      r = Math.max(r, Math.min(s, i)), o = Math.min(o, Math.max(s, i));
    }
    if (n.y != 0) {
      let s = (t18.pos.y - e.p1.y) / n.y,
        i = (t18.pos.y + t18.height - e.p1.y) / n.y;
      r = Math.max(r, Math.min(s, i)), o = Math.min(o, Math.max(s, i));
    }
    return o >= r && o >= 0 && r <= 1;
  }
  function Bt(t18, e) {
    return e.x > t18.pos.x && e.x < t18.pos.x + t18.width && e.y > t18.pos.y &&
      e.y < t18.pos.y + t18.height;
  }
  function Bo(t18, e) {
    let n = Math.max(t18.pos.x, Math.min(e.center.x, t18.pos.x + t18.width)),
      r = Math.max(t18.pos.y, Math.min(e.center.y, t18.pos.y + t18.height));
  ...
  function Ft(t18, e) {
    let n = t18.p2.sub(t18.p1),
      r = n.dot(n),
      o = t18.p1.sub(e.center),
      s = 2 * n.dot(o),
  ...
  function ou(t18, e) {
    return t18.center.sdist(e.center) <
      (t18.radius + e.radius) * (t18.radius + e.radius);
  }
  function Qt(t18, e) {
  ...
  function Lo(t18, e) {
    for (let n = 0; n < t18.pts.length; n++) {
      if (Or(new Oe(t18.pts[n], t18.pts[(n + 1) % t18.pts.length]), e)) {
        return true;
      }
    }
  ...
  function Ar(t18, e) {
    ...
    let n = ae(t18.angle),
      ...
      s = e.x * r + e.y * o,
      i = -e.x * o + e.y * r;
    return s * s / (t18.radiusX * t18.radiusX) +
        i * i / (t18.radiusY * t18.radiusY) < 1;
  }
  function Tn(t18, e) {
    let n = e.center.sub(t18.center),
      r = ae(t18.angle),
      o = Math.cos(r),
      s = Math.sin(r),
      i = n.x * o + n.y * s,
      m = -n.x * s + n.y * o;
    return Ar(
      new Ke(v(), t18.radiusX + e.radius, t18.radiusY + e.radius, 0),
      v(i, m),
    );
  }
  function jo(t18, e) {
    ...
    return e = new Oe(
      n.transform(e.p1.sub(t18.center)),
      n.transform(e.p2.sub(t18.center)),
    ),
      Ft(e, new we(v(), 1));
  }
  function su(t18, e) {
    ...
    let n = new bt(
      ...
      $ =
        (g * R * K - g * V * _ - g * w * H + g * S * U - y * A * K + y * V * Y +
          y * x * H - y * S * L + O * A * _ - O * R * Y - O * x * U +
          O * w * L + A * w * D - A * S * M - R * x * D + R * S * G +
          V * x * M - V * w * G) / J,
      Z =
        (g * U * K - g * H * _ - y * L * K + y * H * Y + O * L * _ - O * U * Y -
          A * M * K + A * D * _ + R * G * K - R * D * Y - V * G * _ +
          V * M * Y + x * M * H - x * D * U - w * G * H + w * D * L +
          S * G * U - S * M * L) / J,
      Ee = (G * U * K - G * H * _ - M * L * K + M * H * Y + D * L * _ -
        D * U * Y) / J;
    if ($ >= 0) {
      let k = -3 * Z + $ ** 2,
        gt = 3 * $ * Ee + Z * $ ** 2 - 4 * Z ** 2,
        Gt = -27 * Ee ** 2 + 18 * Ee * $ * Z + $ ** 2 * Z ** 2 -
          4 * $ ** 3 * Ee - 4 * Z ** 3;
  ...
  function Sr(t18, e) {
    let n = t18.toMat2().inverse;
    return e = new be(e.pts.map((r) => n.transform(r.sub(t18.center)))),
      Qt(new we(v(), 1), e);
  }
  function iu(t18, e) {
  ...
  function du(t18, e, n) {
    ...
    return o >= r && r >= 0 && r <= 1
      ? { point: t18.add(e.scale(r)), normal: s, fraction: r }
      : null;
  }
  function ko(t18, e, n) {
    let r = t18,
  ...
  function hu(t18, e, n) {
    let r = n.toMat2(),
      o = r.inverse,
      s = o.transform(t18.sub(n.center)),
      i = o.transform(e),
      m = ko(s, i, new we(v(), 1));
    if (m) {
      ...
      return {
        point: b,
        normal: u.transform(v(n.radiusY ** 2 * p.x, n.radiusX ** 2 * p.y))
          .unit(),
        fraction: l,
      };
    }
  ...
  function _o(t18, e, n, r = 64) {
    let o = t18,
      ...
      i = e.scale(1 / s),
      m = 0,
      u = v(Math.floor(t18.x), Math.floor(t18.y)),
      c = v(i.x > 0 ? 1 : -1, i.y > 0 ? 1 : -1),
      p = v(Math.abs(1 / i.x), Math.abs(1 / i.y)),
      b = v(
        c.x > 0 ? u.x + 1 - t18.x : t18.x - u.x,
        c.y > 0 ? u.y + 1 - t18.y : t18.y - u.y,
      ),
  ...
  var Ke = class t11 {
    ...
    static fromMat2(e) {
      ...
      return u > c
        ? new t11(v(), u, c, lt(Math.atan2(-i[1], i[0])))
        : new t11(v(), c, u, lt(Math.atan2(-m[1], m[0])));
    }
    toMat2() {
    ...
    contains(e) {
      ...
      let n = ae(this.angle),
        ...
        s = e.x * r + e.y * o,
        i = -e.x * o + e.y * r;
      return s * s / (this.radiusX * this.radiusX) +
          i * i / (this.radiusY * this.radiusY) < 1;
    }
    raycast(e, n) {
      return hu(e, n, this);
    }
  ...
  function Jt(t18, e, n, r, o) {
    ...
    return t18.scale(c).add(e.scale(3 * u * o)).add(n.scale(3 * m * s)).add(
      r.scale(i),
    );
  }
  function qo(t18, e, n, r, o) {
    let s = o * o, i = 1 - o, m = i * i;
    return e.sub(t18).scale(3 * m).add(n.sub(e).scale(6 * i * o)).add(
      r.sub(n).scale(3 * s),
    );
  }
  function zo(t18, e, n, r, o) {
    let s = 1 - o;
    return n.sub(e.scale(2)).add(t18).scale(6 * s).add(
      r.sub(n.scale(2)).add(e).scale(6 * o),
    );
  }
  ...
  function Pr(t18, e, n, r, o, s = Lt) {
    let i = s(e.x, (1 - o) * (n.x - t18.x), (1 - o) * (r.x - e.x), n.x),
      m = s(e.y, (1 - o) * (n.y - t18.y), (1 - o) * (r.y - e.y), n.y);
  ...
  function Xo(t18, e, n, r, o = Lt) {
    return jt(
      r.add(t18.sub(e).scale(6)),
      t18,
      r,
      t18.add(r.sub(n).scale(6)),
      o,
    );
  }
  ...
  function wu(t18, e, n, r) {
    for (let o of t18) {
      if (o !== e && o !== n && o !== r && vu(o, e, n, r)) return true;
    }
    return false;
  }
  ...
  function Mn(t18) {
    ...
    let o = [];
    for (let b = 0; b < t18.length; ++b) {
      rs(t18[n[b]], t18[b], t18[e[b]]) || o.push(t18[b]);
    }
  ...
  var yt = "monospace";
  var Zt = "linear";
  var en = [{ name: "a_pos", size: 2 }, { name: "a_uv", size: 2 }, {
    name: "a_color",
    size: 4,
  }];
...
`;
  ...
  var ze = class {
    ...
    registers = {};
    on(e, n) {
      return this.handlers[e] || (this.handlers[e] = new re()),
  ...
  var It = class {
    ...
    remove() {
      ...
      return this._items.length !== 0 && (this._items[0] = n, this.moveDown(0)),
        e;
    }
    clear() {
    ...
    moveDown(e) {
      for (; e < Math.floor(this._items.length / 2);) {
        ...
        if (
          ...
          !this._compareFn(this._items[n], this._items[n + 1]) && ++n,
            this._compareFn(this._items[e], this._items[n])
        ) break;
        this.swap(e, n), e = n;
      }
  ...
  function Su(t18, e) {
    ...
    return Es(r) && Es(o)
      ? 4
      : Pu(r) && Du(o)
      ? e.slice(t18).indexOf(String.fromCodePoint(917631)) + 2
      : Gu(o)
      ? 4
      : 2;
  }
  ...
  function Du(t18) {
    ...
    return typeof t18 == "string" && typeof e == "number" &&
      xt(e, 917504, 917631);
  }
  function Bu(t18) {
  ...
  var We = (t18, e) =>
    Array.isArray(e) ? e.some((n) => t18.has(n)) : t18.has(e);
  var sn = (t18, e, n) => {
  ...
  function jn() {
    let t18 = a.globalOpt.pixelDensity ?? 1,
      e = a.globalOpt.width,
    ...
    a.gfx.viewport = {
      ...
      width: c,
      height: p,
      scale: (a.gfx.viewport.width + a.gfx.viewport.height) /
        (a.gfx.width + a.gfx.height),
    };
  }
  function Ss(t18) {
    return new E(
      t18.x * a.gfx.viewport.width / a.gfx.width,
      t18.y * a.gfx.viewport.height / a.gfx.height,
    );
  }
  function Qe(t18) {
    return new E(
      (t18.x - a.gfx.viewport.x) * a.gfx.width / a.gfx.viewport.width,
      (t18.y - a.gfx.viewport.y) * a.gfx.height / a.gfx.viewport.height,
    );
  }
  ...
  var Ps = () => {
    let t18 = pt.buttons;
    for (let e in t18) {
      let n = t18[e].keyboard && [t18[e].keyboard].flat(),
        r = t18[e].keyboardCode && [t18[e].keyboardCode].flat(),
        o = t18[e].gamepad && [t18[e].gamepad].flat(),
        s = t18[e].mouse && [t18[e].mouse].flat();
      n && n.forEach((i) => {
  ...
  var ju = (t18) => {
    ...
    return {
      ...
      charInputted: [],
      isMouseMoved: false,
      lastWidth: t18.canvas.offsetWidth,
      lastHeight: t18.canvas.offsetHeight,
      events: new ze(),
    };
  };
  var Ms = (t18) => {
    ...
    function y() {
      return document.fullscreenElement === e.canvas ||
      ...
      let P = 0,
        ...
        te = (Ae) => {
          ...
          let se = Ae / 1e3,
            ...
            Rt = t18.maxFPS ? 1 / t18.maxFPS : 0;
          if (e.realTime = se, B += Ze, B > Rt) {
            if (!e.skipTime) {
              for (
                P += B, e.dt = e.fixedDt, e.restDt = 0;
                P > e.fixedDt;
    ...
    function vo(f) {
      let T = {
        index: f.index,
        isPressed: (P) =>
          e.gamepadStates.get(f.index)?.buttonState.pressed.has(P) || false,
        isDown: (P) =>
          e.gamepadStates.get(f.index)?.buttonState.down.has(P) || false,
        isReleased: (P) =>
          e.gamepadStates.get(f.index)?.buttonState.released.has(P) || false,
        getStick: (P) => e.gamepadStates.get(f.index)?.stickState.get(P) || v(),
      };
      return e.gamepads.push(T),
        e.gamepadStates.set(f.index, {
          buttonState: new vt(),
          stickState: /* @__PURE__ */ new Map([["left", new E(0)], [
            "right",
            new E(0),
          ]]),
        }),
    ...
    function Ja() {
      ...
      for (let f of e.gamepads) {
        ...
        if (!T) continue;
        let B = (t18.gamepads ?? {})[T.id] || Gs[T.id] || Gs.default,
          ...
          for (let Ae = 0; Ae < T.buttons.length; Ae++) {
            ...
            if (Ze.pressed) {
              ...
              e.lastInputDevice = "gamepad",
                Rt && e.buttonsByGamepad.get(se)?.forEach((Re) => {
            ...
            } else {te.buttonState.down.has(se) &&
                (Rt && e.buttonsByGamepad.get(se)?.forEach((Re) => {
      ...
      e.events.onOnce("input", () => {
        ...
        T &&
          (e.lastInputDevice = "mouse",
            e.buttonsByMouse.has(T) && e.buttonsByMouse.get(T)?.forEach((P) => {
    ...
    Me.keydown = (f) => {
      ...
      br.visibilitychange = () => {
        document.visibilityState === "visible"
          ? (e.skipTime = true, e.isHidden = false, e.events.trigger("show"))
          : (e.isHidden = true, e.events.trigger("hide"));
      },
  ...
  var Kn = {
    linear: (t18) => t18,
    easeInSine: (t18) => 1 - Math.cos(t18 * Math.PI / 2),
    easeOutSine: (t18) => Math.sin(t18 * Math.PI / 2),
    easeInOutSine: (t18) => -(Math.cos(Math.PI * t18) - 1) / 2,
    easeInQuad: (t18) => t18 * t18,
    easeOutQuad: (t18) => 1 - (1 - t18) * (1 - t18),
    easeInOutQuad: (t18) =>
      t18 < 0.5 ? 2 * t18 * t18 : 1 - Math.pow(-2 * t18 + 2, 2) / 2,
    easeInCubic: (t18) => t18 * t18 * t18,
    easeOutCubic: (t18) => 1 - Math.pow(1 - t18, 3),
    easeInOutCubic: (t18) =>
      t18 < 0.5 ? 4 * t18 * t18 * t18 : 1 - Math.pow(-2 * t18 + 2, 3) / 2,
    easeInQuart: (t18) => t18 * t18 * t18 * t18,
    easeOutQuart: (t18) => 1 - Math.pow(1 - t18, 4),
    easeInOutQuart: (t18) =>
      t18 < 0.5 ? 8 * t18 * t18 * t18 * t18 : 1 - Math.pow(-2 * t18 + 2, 4) / 2,
    easeInQuint: (t18) => t18 * t18 * t18 * t18 * t18,
    easeOutQuint: (t18) => 1 - Math.pow(1 - t18, 5),
    easeInOutQuint: (t18) =>
      t18 < 0.5
        ? 16 * t18 * t18 * t18 * t18 * t18
        : 1 - Math.pow(-2 * t18 + 2, 5) / 2,
    easeInExpo: (t18) => t18 === 0 ? 0 : Math.pow(2, 10 * t18 - 10),
    easeOutExpo: (t18) => t18 === 1 ? 1 : 1 - Math.pow(2, -10 * t18),
    easeInOutExpo: (t18) =>
      t18 === 0
        ? 0
        : t18 === 1
        ? 1
        : t18 < 0.5
        ? Math.pow(2, 20 * t18 - 10) / 2
        : (2 - Math.pow(2, -20 * t18 + 10)) / 2,
    easeInCirc: (t18) => 1 - Math.sqrt(1 - Math.pow(t18, 2)),
    easeOutCirc: (t18) => Math.sqrt(1 - Math.pow(t18 - 1, 2)),
    easeInOutCirc: (t18) =>
      t18 < 0.5
        ? (1 - Math.sqrt(1 - Math.pow(2 * t18, 2))) / 2
        : (Math.sqrt(1 - Math.pow(-2 * t18 + 2, 2)) + 1) / 2,
    easeInBack: (t18) => Bs * t18 * t18 * t18 - 1.70158 * t18 * t18,
    easeOutBack: (t18) =>
      1 + Bs * Math.pow(t18 - 1, 3) + 1.70158 * Math.pow(t18 - 1, 2),
    easeInOutBack: (t18) =>
      t18 < 0.5
        ? Math.pow(2 * t18, 2) * ((In + 1) * 2 * t18 - In) / 2
        : (Math.pow(2 * t18 - 2, 2) * ((In + 1) * (t18 * 2 - 2) + In) + 2) / 2,
    easeInElastic: (t18) =>
      t18 === 0
        ? 0
        : t18 === 1
        ? 1
        : -Math.pow(2, 10 * t18 - 10) * Math.sin((t18 * 10 - 10.75) * Fs),
    easeOutElastic: (t18) =>
      t18 === 0
        ? 0
        : t18 === 1
        ? 1
        : Math.pow(2, -10 * t18) * Math.sin((t18 * 10 - 0.75) * Fs) + 1,
    easeInOutElastic: (t18) =>
      t18 === 0
        ? 0
        : t18 === 1
        ? 1
        : t18 < 0.5
        ? -(Math.pow(2, 20 * t18 - 10) * Math.sin((20 * t18 - 11.125) * Ls)) / 2
        : Math.pow(2, -20 * t18 + 10) * Math.sin((20 * t18 - 11.125) * Ls) / 2 +
          1,
    easeInBounce: (t18) => 1 - Kn.easeOutBounce(1 - t18),
    easeOutBounce: (t18) =>
      t18 < 1 / 2.75
        ? 7.5625 * t18 * t18
        : t18 < 2 / 2.75
        ? 7.5625 * (t18 -= 1.5 / 2.75) * t18 + 0.75
        : t18 < 2.5 / 2.75
        ? 7.5625 * (t18 -= 2.25 / 2.75) * t18 + 0.9375
        : 7.5625 * (t18 -= 2.625 / 2.75) * t18 + 0.984375,
    easeInOutBounce: (t18) =>
      t18 < 0.5
        ? (1 - Kn.easeOutBounce(1 - 2 * t18)) / 2
        : (1 + Kn.easeOutBounce(2 * t18 - 1)) / 2,
  };
  var nt = Kn;
  function Wu(t18, e, n) {
    let r = [], o = e;
  ...
  var jr = class {
    ...
    isLeft(e, n) {
      return (this.b.x - this.a.x) * (n - this.a.y) -
  ...
  function dt(t18) {
    let e = new fe();
    return t18.pos && e.translate(t18.pos),
      t18.scale && e.scale(t18.scale),
      t18.angle && e.rotate(t18.angle),
      t18.parent ? e.mult(t18.parent.transform) : e;
  }
  function js(t18) {
  ...
  function _n() {
    return (a.gfx.viewport.width + a.gfx.viewport.height) /
      (a.gfx.width + a.gfx.height);
  }
  function Ct() {
    return v(ie() / 2, ue() / 2);
  ...
  var ft = class {
    ...
    getFailedAssets() {
      return Array.from(this.assets.keys()).filter((e) =>
        this.assets.get(e).error !== null
  ...
  function Tt(t18) {
    ...
    return e.crossOrigin = "anonymous",
      ...
      new Promise((n, r) => {
        e.onload = () => n(e),
          e.onerror = () => r(new Error(`Failed to load image from "${t18}"`));
      });
  }
  function Be() {
    let t18 = [
  ...
  var Fe = class t15 {
    ...
    static from(e, n = {}) {
      return typeof e == "string"
        ? t15.fromURL(e, n)
        : Promise.resolve(t15.fromImage(e, n));
    }
    ...
    return e = pe(e),
      Array.isArray(e)
        ? e.some((r) => typeof r == "string")
          ...
          : a.assets.sprites.addLoaded(t18, Ys(e, n))
        : typeof e == "string"
        ? a.assets.sprites.add(t18, Fe.from(e, n))
        : a.assets.sprites.addLoaded(t18, Fe.fromImage(e, n));
  }
  function Ur(t18 = 1, e = 1, n = 0, r = 0, o = 1, s = 1) {
    let i = [], m = o / t18, u = s / e;
    for (let c = 0; c < e; c++) {
      for (let p = 0; p < t18; p++) i.push(new q(n + p * m, r + c * u, m, u));
    }
    return i;
  }
  function Ys(t18, e = {}) {
    ...
    return a.assets.sprites.add(
      ...
      r.then((o) => {
        ...
        for (let u of o.meta.frameTags) {
          u.from === u.to ? m[u.name] = u.from : m[u.name] = {
            from: u.from,
            to: u.to,
            speed: 10,
            loop: true,
  ...
  function Qs(t18, e, n = {}) {
    let r = pe(e),
      o = new FontFace(t18, typeof e == "string" ? `url(${r})` : r);
    return document.fonts.add(o),
      a.assets.fonts.add(
        t18,
        o.load().catch((s) => {
  ...
  var ot = class t16 {
    ...
    static fromURL(e) {
      return Fn(e)
        ? t16.fromArrayBuffer(ys(e))
        : Ns(e).then((n) => t16.fromArrayBuffer(n));
    }
  };
  function oi(t18) {
    if (typeof t18 == "string") {
  ...
  function Pe(t18) {
    ...
    if (!(e < 3)) {
      if (
        ...
        let n = t18.color ?? j.WHITE,
          r = t18.pts.map((s, i) => ({
            pos: new E(s.x, s.y),
            uv: t18.uv ? t18.uv[i] : new E(0, 0),
            color: t18.colors && t18.colors[i] ? t18.colors[i].mult(n) : n,
            opacity: t18.opacity ?? 1,
          })),
          o;
        t18.triangulate
          ? o = Mn(t18.pts).map((i) => i.map((m) => t18.pts.indexOf(m))).flat()
          : o = [...Array(e - 2).keys()].map((s) => [0, s + 1, s + 2]).flat(),
          Le(
            r,
            t18.indices ?? o,
            t18.fixed,
            t18.uv ? t18.tex : a.gfx.defTex,
            t18.shader,
            t18.uniform ?? void 0,
          );
      }
      t18.outline && kt({
        pts: [...t18.pts, t18.pts[0]],
        radius: t18.radius,
        width: t18.outline.width,
        color: t18.outline.color,
        join: t18.outline.join,
        uniform: t18.uniform,
        fixed: t18.fixed,
        opacity: t18.opacity ?? t18.outline.opacity,
      }), me();
    }
  }
  function zn(t18) {
    ...
    let e = t18.start ?? 0,
      n = t18.end ?? 360,
      r = _e(t18.anchor ?? "center").scale(new E(-t18.radiusX, -t18.radiusY)),
      o = wt(r, t18.radiusX, t18.radiusY, e, n, t18.resolution);
    o.unshift(r);
    let s = Object.assign({}, t18, {
      pts: o,
      radius: 0,
      ...t18.gradient
        ? {
          colors: [
            t18.gradient[0],
            ...Array(o.length - 1).fill(t18.gradient[1]),
          ],
        }
        : {},
    });
    if (n - e >= 360 && t18.outline) {
      t18.fill !== false && Pe(Object.assign({}, s, { outline: null })),
        Pe(Object.assign({}, s, { pts: o.slice(1), fill: false }));
      return;
    }
    Pe(s);
  }
  ...
  function _t(t18) {
    ...
    let r = t18.width || 1,
      o = n.sub(e).unit().normal().scale(r * 0.5),
      s = [e.sub(o), e.add(o), n.add(o), n.sub(o)].map((i) => ({
        pos: new E(i.x, i.y),
        uv: new E(0),
        color: t18.color ?? j.WHITE,
        opacity: t18.opacity ?? 1,
      }));
    Le(
      s,
  ...
  function $u(t18) {
    ...
    if (!o) {
      switch (n.push(p.add(u)), n.push(p.sub(u)), t18.cap) {
        case "square": {
          let d = i.scale(r / m);
          n.push(p.add(d).add(u)), n.push(p.add(d).sub(u));
          break;
    ...
    (l[h++] = n.length - 1,
      ...
      l[h++] = 1,
      l[h++] = n.length - 1),
      Le(b, l, t18.fixed, a.gfx.defTex, t18.shader, t18.uniform ?? void 0);
  }
  function Xu(t18) {
    let e = t18.pts,
      n = [],
  ...
  function kt(t18) {
    ...
    if (!(e.length < 2)) {
      ...
      if (t18.radius && e.length >= 3) {
        ...
        _t(
          Object.assign({}, t18, { p1: e[e.length - 2], p2: e[e.length - 1] }),
        );
      } else {for (let r = 0; r < e.length - 1; r++) {
          _t(Object.assign({}, t18, { p1: e[r], p2: e[r + 1] })),
            t18.join !== "none" &&
            Ne(Object.assign({}, t18, { pos: e[r], radius: n / 2 }));
        }}
    }
  }
  function Wn(t18, e) {
  ...
  var Ve = class t17 {
    ...
    constructor(e, n, r, o = {}) {
      ...
      this.bind(),
        ...
        s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL, true),
        this.unbind();
    }
  ...
  var Yn = class {
    ...
    push(e, n, r, o, s = null, i = {}) {
      (e !== this.curPrimitive || s !== this.curTex || o !== this.curShader ||
        !Ln(this.curUniform, i) ||
        this.vqueue.length + n.length * this.stride > this.maxVertices ||
        this.iqueue.length + r.length > this.maxIndices) && this.flush();
    ...
    flush() {
      if (
        !this.curPrimitive || !this.curShader || this.vqueue.length === 0 ||
    ...
    function i(V) {
      ...
      V.reduce(
        (
          ...
          S,
          G,
        ) => (t18.vertexAttribPointer(G, S.size, t18.FLOAT, false, x * 4, w),
          t18.enableVertexAttribArray(G),
          w + S.size * 4),
        0,
      );
    }
    let [m, u] = St((V) => t18.bindTexture(t18.TEXTURE_2D, V)),
      [c, p] = St((V) => t18.bindBuffer(t18.ARRAY_BUFFER, V)),
      [b, l] = St((V) => t18.bindBuffer(t18.ELEMENT_ARRAY_BUFFER, V)),
      [h, d] = St((V) => t18.bindFramebuffer(t18.FRAMEBUFFER, V)),
      [C, g] = St((V) => t18.bindRenderbuffer(t18.RENDERBUFFER, V)),
      [y, O] = St((V) => {
        if (!V) return;
        let { x, y: w, w: S, h: G } = V;
  ...
  function mi(t18, e) {
    ...
    e.pos && (t18.pos = t18.pos.add(e.pos)),
      e.scale && (t18.scale = t18.scale.scale(v(e.scale))),
      e.angle && (t18.angle += e.angle),
      e.color && t18.ch.length === 1 && (t18.color = t18.color.mult(e.color)),
      e.opacity != null && (t18.opacity *= e.opacity);
  }
  function $n(t18) {
    let e = {},
      n = "",
  ...
  function Ue(t18) {
    ...
    if (e instanceof At || typeof e == "string") {
      ...
      for (let x of o) {
        if (!V.font.map[x]) {
          ...
          if (!G) continue;
          let M = Math.ceil(Math.abs(S.actualBoundingBoxAscent)) +
            Math.ceil(Math.abs(S.actualBoundingBoxDescent));
          V.outline && V.outline.width && V.outline.color &&
          (w.lineJoin = "round",
    ...
    let s = t18.size || e.size,
      i = v(t18.scale ?? 1).scale(s / e.size),
      m = t18.lineSpacing ?? 0,
      u = t18.letterSpacing ?? 0,
      c = 0,
      p = 0,
      b = 0,
      l = [],
...
`
        ...
        if (R) {
          ...
          (b += s + m,
            ...
            A === " " && (C = h.length, g = c),
            t18.indentAll && y === void 0 && /\S/.test(A) && (y = c),
            c += V,
            p = Math.max(p, c),
            c += u;
        }
    ...
    for (let A = 0; A < l.length; A++) {
      ...
      for (let V of l[A].chars) {
        ...
        if (
          ...
          let S = typeof t18.transform == "function"
            ? t18.transform(w, V.ch)
            : t18.transform;
          S && mi(V, S);
        }
        if (n[w]) {
  ...
  function it(t18) {
    ...
    let e = t18.width,
      n = t18.height,
      o = _e(t18.anchor || mt).scale(new E(e, n).scale(-0.5)),
      s = t18.quad || new q(0, 0, 1, 1),
      i = t18.color || I(255, 255, 255),
      m = t18.opacity ?? 1,
      u = t18.tex ? 0.1 / t18.tex.width : 0,
      c = t18.tex ? 0.1 / t18.tex.height : 0,
      p = s.x + u,
      b = s.y + c,
      l = s.w - u * 2,
      h = s.h - c * 2;
    ge(),
      ...
      Le(
        [{
          pos: new E(-e / 2, n / 2),
          uv: new E(t18.flipX ? p + l : p, t18.flipY ? b : b + h),
          color: i,
          opacity: m,
        }, {
          pos: new E(-e / 2, -n / 2),
          uv: new E(t18.flipX ? p + l : p, t18.flipY ? b + h : b),
          color: i,
          opacity: m,
        }, {
          pos: new E(e / 2, -n / 2),
          uv: new E(t18.flipX ? p : p + l, t18.flipY ? b + h : b),
          color: i,
          opacity: m,
        }, {
          pos: new E(e / 2, n / 2),
          uv: new E(t18.flipX ? p : p + l, t18.flipY ? b : b + h),
          color: i,
          opacity: m,
        }],
        [0, 1, 3, 1, 2, 3],
  ...
  function He(t18) {
    ge(),
      ...
      Ye(t18.opt.angle),
      X(
        _e(t18.opt.anchor ?? "topleft").add(1, 1).scale(t18.width, t18.height)
          .scale(-0.5),
      ),
      t18.chars.forEach((e) => {
        it({
          ...
          quad: e.quad,
          anchor: "center",
          uniform: t18.opt.uniform,
          shader: t18.opt.shader,
          fixed: t18.opt.fixed,
        });
      }),
      me();
  ...
  function xe(t18) {
    ...
    let e = t18.width,
      n = t18.height,
      o = _e(t18.anchor || mt).add(1, 1).scale(new E(e, n).scale(-0.5)),
      s = [new E(0, 0), new E(e, 0), new E(e, n), new E(0, n)];
    if (t18.radius) {
      let i = Math.min(e, n) / 2,
        m = Array.isArray(t18.radius)
          ? t18.radius.map((u) => Math.min(i, u))
          : new Array(4).fill(Math.min(i, t18.radius));
      s = [
        new E(m[0], 0),
    ...
    Pe(Object.assign({}, t18, {
      offset: o,
      pts: s,
      ...t18.gradient
        ? {
          colors: t18.horizontal
            ? [
              t18.gradient[0],
              t18.gradient[1],
              t18.gradient[1],
...
`),
    ...
    a.debug.paused && qe(() => {
      ...
      a.debug.timeScale !== 1 && qe(() => {
        ...
        xe({
          width: e.width + t18 * 2 + t18 * 4,
          height: e.height + t18 * 2,
          anchor: "botright",
          color: I(0, 0, 0),
          opacity: 0.8,
          radius: 4,
        ...
        for (let n = 0; n < 2; n++) {
          ...
          Xn({
            p1: v(-e.width - t18 * (r ? 2 : 3.5), -t18),
            p2: v(-e.width - t18 * (r ? 2 : 3.5), -t18 - e.height),
            p3: v(-e.width - t18 * (r ? 3.5 : 2), -t18 - e.height / 2),
            pos: v(-n * t18 * 1 + (r ? -t18 * 0.5 : 0), 0),
            color: I(255, 255, 255),
            fixed: true,
          });
        }
      ...
      a.debug.showLog && a.game.logs.length > 0 && qe(() => {
        ...
        a.game.logs = a.game.logs.filter((r) =>
          a.app.time() - r.time < (a.globalOpt.logTime || 4)
        );
        let n = Ue({
          text: e.join(`
`),
  ...
  function Jr(t18, e = false, n = /* @__PURE__ */ new Set()) {
    ...
    var r = "", o;
    return e && typeof t18 == "string" && (t18 = JSON.stringify(t18)),
      Array.isArray(t18) &&
      (r = [
        "[",
        t18.map((s) => Jr(s, true, n.union(/* @__PURE__ */ new Set([t18]))))
          .join(", "),
        "]",
      ].join(""),
        t18 = r),
      t18 === null ? "null" : (typeof t18 == "object" &&
        t18.toString === Object.prototype.toString &&
        (t18.constructor !== Object && (r += t18.constructor.name + " "),
          r += [
            "{",
            (o = Object.getOwnPropertyNames(t18).map((s) =>
                `${/^\w+$/.test(s) ? s : JSON.stringify(s)}: ${
                  Jr(t18[s], true, n.union(/* @__PURE__ */ new Set([t18])))
                }`
              ).join(", "))
              ? ` ${o} `
              : "",
          ...
          t18 = r),
        String(t18).replaceAll(/(?<!\\)\[/g, "\\["));
  }
  function fi() {
    let t18 = a.game.cam, e = E.fromAngle(he(0, 360)).scale(t18.shake);
    t18.shake = de(t18.shake, 0, 5 * ee()),
      t18.transform = new fe().translate(Ct()).scale(t18.scale).rotate(
        t18.angle,
      ).translate((t18.pos ?? Ct()).scale(-1).add(e)),
      a.game.root.draw(),
      Ce();
  }
  function hi() {
    ...
    a.game.events.numListeners("loading") > 0
      ? a.game.events.trigger("loading", t18)
      : qe(() => {
        let e = ie() / 2,
          n = 24,
  ...
  function Vt(t18) {
    ...
    let e = t18.quad ?? new q(0, 0, 1, 1),
      n = t18.tex.width * e.w,
      r = t18.tex.height * e.h,
      o = new E(1);
    if (t18.tiled) {
      let s = _e(t18.anchor || mt),
        i = (t18.pos?.x || 0) - (s.x + 1) * 0.5 * (t18.width || n),
        m = (t18.pos?.y || 0) - (s.y + 1) * 0.5 * (t18.height || r),
        u = (t18.width || n) / n,
        c = (t18.height || r) / r,
        p = Math.floor(u),
        b = Math.floor(c),
      ...
      if (h) {
        for (let A = 0; A < p; A++) {
          O(
            ...
            n,
            r * h,
            new q(e.x, e.y, e.w, e.h * h),
          );
        }
        l && O(p * n, b * r, n * l, r * h, new q(e.x, e.y, e.w * l, e.h * h));
      }
      Le(g, C, t18.fixed, t18.tex, t18.shader, t18.uniform ?? void 0);
    } else {t18.width && t18.height
        ? (o.x = t18.width / n, o.y = t18.height / r)
        : t18.width
        ? (o.x = t18.width / n, o.y = o.x)
        : t18.height && (o.y = t18.height / r, o.x = o.y),
        it(
          Object.assign({}, t18, {
            scale: o.scale(t18.scale || new E(1)),
            tex: t18.tex,
            quad: e,
            width: n,
            height: r,
  ...
  function bi(t18) {
    ...
    Vt(
      Object.assign({}, t18, {
        tex: e.data.tex,
        quad: n.scale(t18.quad ?? new q(0, 0, 1, 1)),
      }),
    );
  }
  function yi(t18, e) {
  ...
  var xi = (t18, e) => {
    let n = qn(e, tn, nn),
      ...
      m = t18.width && t18.height
        ? new st(e, t18.width * r * o, t18.height * r * o)
        : new st(e, s.drawingBufferWidth, s.drawingBufferHeight),
      u = null,
      c = 1;
    t18.background &&
    (typeof t18.background == "string"
      ? u = I(t18.background)
      : (u = I(...t18.background), c = t18.background[3] ?? 1),
    ...
    return {
      ...
      bgColor: u,
      bgAlpha: c,
      width: t18.width ?? s.drawingBufferWidth / r / o,
      height: t18.height ?? s.drawingBufferHeight / r / o,
      viewport: {
        x: 0,
        y: 0,
  ...
  function Ci(t18 = 1) {
    ...
    return {
      ...
      update() {
        r ||
          (n += ee(),
            this.opacity = Se(n, 0, t18, 0, e),
            n >= t18 && (this.opacity = e, r = true));
      },
    };
  }
  ...
  function Oi(t18, e) {
    let n = e.lifetime,
      r = [],
      o = t18.colors || [j.WHITE],
      s = t18.opacities || [1],
      i = t18.quads || [new q(0, 0, 1, 1)],
      m = t18.scales || [1],
      u = t18.lifeTime,
      c = e.direction,
      p = e.spread,
      b = t18.speed || [0, 0],
      l = t18.angle || [0, 0],
      h = t18.angularVelocity || [0, 0],
      d = t18.acceleration || [v(0), v(0)],
      C = t18.damping || [0, 0],
      g = [],
      y = new Array(t18.max),
      O = 0,
        ...
        if (!(n !== void 0 && n <= 0)) {
          for (let x = 0; x < r.length; x++) {
            ...
            let S = w.progress,
              ...
              $ = (t18.texture ? t18.texture.width : 10) * H.w / 2,
              Z = (t18.texture ? t18.texture.height : 10) * H.h / 2,
              Ee = x * 4,
              k = y[Ee];
  ...
  function Ai(t18, e = {}) {
    if (t18.length < 3) {
      throw new Error(
        `Polygon's need more than two points, ${t18.length} points provided`,
      );
    }
    return {
      id: "polygon",
    ...
    let n = a.game.root.add([Pt(e.pos ?? v(0))]),
      ...
      d = () => {
        ...
        for (let w of n.children) {
          ...
          (w.tilePos.x != S.x || w.tilePos.y != S.y) &&
            (x = true, h(w), w.tilePos.x = S.x, w.tilePos.y = S.y, l(w));
        }
      ...
      V = {
        ...
        spawn(x, ...w) {
          ...
          let L = n.add(G);
          return M && (L.tilePosOffset = L.pos.clone()),
            L.tilePos = S,
            L.transform = dt(L),
            s &&
            (l(L),
        ...
        raycast(x, w) {
          let S = this.toWorld(x),
            ...
            L = _o(D, w, (U) => {
              ...
              return Y && (Y.point = this.fromWorld(Y.point).scale(M)),
                Y || false;
            }, 64);
  ...
  function Ge(t18, e, n) {
    return a.game.objEvents.registers[t18] ||
      (a.game.objEvents.registers[t18] = new rn()),
      a.game.objEvents.on(t18, (r, ...o) => {
        r.is(e) && n(r, ...o);
      });
  }
  var Pi = (t18, e, ...n) => {
  ...
  var to = ne(
    (t18) => a.game.events.on("add", t18),
    (t18, e) => Ge("add", t18, e),
  );
  var Ri = ne(
    (t18) => a.game.events.on("destroy", t18),
    (t18, e) => Ge("destroy", t18, e),
  );
  var Di = ne(
    (t18) => a.game.events.on("use", t18),
    (t18, e) => Ge("use", t18, e),
  );
  var Bi = ne(
    (t18) => a.game.events.on("unuse", t18),
    (t18, e) => Ge("unuse", t18, e),
  );
  var no = ne(
    (t18) => a.game.events.on("tag", t18),
    (t18, e) => Ge("tag", t18, e),
  );
  var Fi = ne(
    (t18) => a.game.events.on("untag", t18),
    (t18, e) => Ge("untag", t18, e),
  );
  function Li(t18, e, n) {
  ...
  function or(t18, e) {
    a.game.root.get(t18, { recursive: true }).forEach(e),
      to(t18, e),
      no((n, r) => {
        r === t18 && e(n);
      });
  ...
  function co(t18 = I(255, 255, 255), e = 1) {
    let n = a.game.root.add([tr(ie(), ue()), Jn(t18), Zn(1), ar()]),
      r = n.fadeOut(e);
  ...
  function Xi(...t18) {
    return tt("camPos", "setCamPos / getCamPos"),
      t18.length > 0 && ro(...t18),
      oo();
  }
  function Qi(...t18) {
    return tt("camScale", "setCamScale / getCamScale"),
      t18.length > 0 && so(...t18),
      io();
  }
  function Ji(t18) {
    return tt("camRot", "setCamRot / getCamRot"),
      t18 !== void 0 && ao(t18),
      uo();
  }
    ...
    let e = /* @__PURE__ */ new Map(),
      ...
      p = {
        ...
        readd(l) {
          ...
          return h !== -1 &&
            (this.children.splice(h, 1), this.children.push(l)),
            l;
        },
        remove(l) {
          let h = this.children.indexOf(l);
            ...
            if (g) {
              if (
                typeof g.value == "function" && (l[C] = l[C].bind(this)),
                  g.set &&
                  Object.defineProperty(l, C, { set: g.set.bind(this) }),
                  g.get &&
                  Object.defineProperty(l, C, { get: g.get.bind(this) }),
                  ps.has(C)
              ) {
                let y = C === "add"
                  ? () => {
        ...
        query(l) {
          ...
          if (
            ...
            ((l.includeOp || "and") === "and" || !Array.isArray(l.include)
              ...
              l.visible === true && (g = g.filter((y) => y.visible)),
              l.distance
          ) {
            if (!this.pos) {
              throw Error(
        ...
        is(l, h = "and") {
          return Array.isArray(l)
            ? h === "and" ? l.every((d) => i.has(d)) : l.some((d) => i.has(d))
            : i.has(l);
        },
        tag(l) {
          if (Array.isArray(l)) {
        ...
        has(l, h = "and") {
          return Array.isArray(l)
            ? h === "and" ? l.every((d) => e.has(d)) : l.some((d) => e.has(d))
            : e.has(l);
        },
        on(l, h) {
  ...
  function ra(t18) {
    a.game.gravity = t18.unit().scale(
      a.game.gravity ? a.game.gravity.len() : 1,
    );
  }
  function ht() {
  ...
  function ia(t18, e = {}) {
    ...
    function s() {
      a.debug.paused || a.app.isHidden() && !a.globalOpt.backgroundAudio ||
        a.audio.ctx.resume();
    }
    function i() {
      s(), r.play();
  ...
  function aa(t18, e = {}) {
    ...
    return {
      ...
      set paused(g) {
        if (r !== g) {
          if (r = g, g) b && (o.stop(), b = false), p = n.currentTime;
          else {
            o = C(o);
            let y = p - c;
  ...
  function ua(t18) {
    return tt("volume", "setVolume / getVolume"),
      t18 !== void 0 && lo(t18),
      mo();
  }
  function cr() {
    a.app.onHide(() => {
      ...
      a.app.onResize(() => {
        ...
        t18 && !a.globalOpt.stretch && !a.globalOpt.letterbox ||
          (a.canvas.width = a.canvas.offsetWidth * a.pixelDensity,
            a.canvas.height = a.canvas.offsetHeight * a.pixelDensity,
            jn(),
            t18 || (a.gfx.frameBuffer.free(),
              a.gfx.frameBuffer = new st(
                a.gfx.ggl,
                a.gfx.ggl.gl.drawingBufferWidth,
                a.gfx.ggl.gl.drawingBufferHeight,
              ),
              a.gfx.width = a.gfx.ggl.gl.drawingBufferWidth / a.pixelDensity /
                a.gscale,
              a.gfx.height = a.gfx.ggl.gl.drawingBufferHeight / a.pixelDensity /
                a.gscale));
      }),
      a.globalOpt.debug !== false &&
      (a.app.onKeyPress(
  ...
  function ca(t18, e = {}) {
    let n = a.game.root.add([Pt(t18), lr()]),
      r = (e.speed || 1) * 5,
      o = e.scale || 1;
    ...
    return s.wait(0.4 / r, () => s.use(po(r, o))),
  ...
  function ha(t18, ...e) {
    ...
    a.game.events.onOnce("frameEnd", () => {
      a.game.events.trigger("sceneLeave", t18),
        a.app.events.clear(),
        a.game.events.clear(),
        a.game.objEvents.clear(),
        [...a.game.root.children].forEach((n) => {
          !n.stay || n.scenesToStay && !n.scenesToStay.includes(t18)
            ? a.game.root.remove(n)
            : n.trigger("sceneEnter", t18);
        }),
  ...
  function fn(t18, e = {}) {
    ...
    let i = (c, p, b, l) => {
      ...
      u = (c) => {
        ...
        for (let l = 0; l < b; l++) {
          p.push(
            c.from + l * Math.sign(c.to - c.from),
          );
        }
        ...
        r && this.stop(),
          r = typeof b == "number"
            ...
            : {
              name: c,
              timer: 0,
              loop: p.loop ?? b.loop ?? false,
              pingpong: p.pingpong ?? b.pingpong ?? false,
  ...
  function ya(t18, e = {}) {
    function n(o) {
      ...
      return e.width || (o.width = s.width / (o.scale?.x || 1)),
  ...
  function va(t18 = {}) {
    ...
    return {
      id: "agent",
      require: ["pos", "tile"],
      agentSpeed: t18.speed ?? 100,
      allowDiagonals: t18.allowDiagonals ?? true,
      getDistanceToTarget() {
      ...
      setTarget(s) {
        e = s,
          ...
          r = n ? 0 : null,
          n && r !== null
            ? (o || (o = this.getLevel().onNavigationMapChanged(() => {
              e && n && r !== null &&
                (n = this.getLevel().getPath(this.pos, e, {
                  allowDiagonals: this.allowDiagonals,
                }),
        ...
        if (!(!e || !i || s) && (this.moveTo(i, n), this.pos.sdist(i) < 9)) {
          switch (r) {
            ...
            case "stop":
              o < e.length - 1
                ? o += 1
                : s || (s = true, this.trigger("patrolFinished", this));
              break;
          }
        }
      },
  ...
  function Ea(t18, e = {}) {
    let n = typeof t18 == "function" ? t18 : () => a.game.root.query(t18),
      r = e.checkFrequency || 1,
      o = typeof e.direction == "number"
        ? E.fromAngle(e.direction)
        : e.direction,
      s = 0;
    return {
      id: "sentry",
      require: ["pos"],
      direction: typeof e.direction == "number"
        ? E.fromAngle(e.direction)
        : e.direction,
      spotted: [],
      ...
      update() {
        if (s += ee(), s > r) {
          ...
          if (i.length && o && this.fieldOfView && this.fieldOfView < 360) {
            ...
            i = i.filter((u) =>
              u.pos && o.angleBetween(u.pos.sub(this.pos)) <= m
            );
          }
          i.length && e.lineOfSight &&
  ...
  var bn = class {
      ...
      if (
        s -= i,
          (this.direction == "reverse" ||
            this.direction == "ping-pong" && i & 1) && (s = 1 - s),
          r
      ) {
        let m = 0;
    ...
    serialize() {
      ...
      return this.loops && (e.loops = this.loops),
  ...
  function Oa(t18 = {}) {
    ...
    return {
      id: "animate",
      require: t18.followMotion ? ["rotate"] : void 0,
      ...
      animate(o, s, i) {
        r = false,
          this.unanimate(o),
          typeof s[0] == "number"
            ? e.push(new ho(o, s, i, t18.relative || false))
            : s[0] instanceof E
            ? e.push(
              new go2(
                o,
                ...
                i,
                t18.relative || false,
                o === "pos" && (t18.followMotion || false),
              ),
            )
            : s[0] instanceof j &&
              e.push(new bo(o, s, i, t18.relative || false));
      },
      unanimate(o) {
      ...
      serializeAnimationOptions() {
        let o = {};
        return t18.followMotion && (o.followMotion = true),
          t18.relative && (o.relative = true),
          o;
      },
    };
  }
  function yo(t18, e) {
    let n = { name: t18.name };
    return t18.has("animate") &&
      (n.channels = t18.serializeAnimationChannels(),
        Object.assign(n, t18.serializeAnimationOptions())),
      t18.children.length > 0 &&
      (n.children = t18.children.filter((r) => r.has("named")).map((r) =>
        yo(r, r.name)
      )),
      n;
  }
    ...
    return {
      ...
      enterState(u, ...c) {
        ...
        if (n) {
          ...
          if (!b.includes(u)) {
            throw new Error(
              `Cannot transition state from "${p}" to "${u}". Available transitions: ${
                b.map((l) => `"${l}"`).join(", ")
              }`,
            );
          }
  ...
  function Ga(t18 = true, e) {
    ...
    return {
      ...
      add() {
        ...
        n = a.k.onCharInput((s) => {
          this.hasFocus && (!e || this.typedText.length < e) &&
            (a.k.isKeyDown("shift")
  ...
  function gn(t18 = 1e3) {
    return {
      id: "timer",
      maxLoopsPerFrame: t18,
      loop(e, n, r = 1 / 0, o = false) {
        let s = o ? 0 : e,
          i = new re(),
          m = this.onUpdate(() => {
            s += a.app.state.dt;
  ...
  function Ra(t18 = {}) {
    ...
    return {
      id: "area",
      collisionIgnore: t18.collisionIgnore ?? [],
      add() {
        xo++,
          this.area.cursor &&
          r.push(this.onHover(() => a.app.setCursor(this.area.cursor))),
          r.push(this.onCollideUpdate((o, s) => {
            if (!o.id) {
      ...
      area: {
        shape: t18.shape ?? null,
        scale: t18.scale ? v(t18.scale) : v(1),
        offset: t18.offset ?? v(0),
        cursor: t18.cursor ?? null,
      },
      isClicked() {
      ...
      resolveCollision(o) {
        ...
        s && !s.resolved &&
          (this.pos = this.pos.add(s.displacement), s.resolved = true);
      },
      localArea() {
      ...
      worldArea() {
        ...
        let s = this.transform.clone().translate(this.area.offset).scale(
          v(this.area.scale ?? 1),
        );
        if (o instanceof W) {
          let i = _e(this.anchor || mt).add(1, 1).scale(-0.5).scale(
            o.width,
            o.height,
          );
          s.translate(i);
  ...
  function Da(t18 = {}) {
    ...
    return {
      ...
      vel: v(0),
      drag: t18.drag ?? 0,
      jumpForce: t18.jumpForce ?? ds,
      gravityScale: t18.gravityScale ?? 1,
      isStatic: t18.isStatic ?? false,
      mass: t18.mass ?? 1,
      add() {
        if (
          s = this.pos.clone(),
            ...
            if (a.game.gravity) {
              if (u.isBottom() && this.isFalling()) {
                ...
                e = u.target,
                  c != e && (n = u.target.pos),
                  r ? r = false : c ||
                    (this.trigger("ground", e), u.target.trigger("land", this));
              } else {u.isTop() && this.isJumping() &&
                  (this.vel = this.vel.reject(a.game.gravity.unit()),
      ...
      update() {
        e && this.isColliding(e) && e.exists() && e.has("body") &&
          (n && !e.pos.eq(n) && t18.stickToPlatform !== false &&
      ...
      fixedUpdate() {
        if (
          ...
          (this.pos.x == m.x && (this.pos.x = s.x),
            ...
            s = null), a.game.gravity && !this.isStatic
        ) {
          ...
          this.vel.slen() > p * p && (this.vel = this.vel.unit().scale(p)),
            c.dot(a.game.gravity) < 0 && this.vel.dot(a.game.gravity) >= 0 &&
            this.trigger("fall");
        }
        if (
          this.vel.x += o.x * ee(),
      ...
      jump(u) {
        this.isStatic ||
          (e = null, n = null, this.vel = ht().scale(-u || -this.jumpForce));
      },
      onGround(u) {
  ...
  function Fa(t18) {
    return {
      ...
      require: ["area"],
      speed: t18.speed,
      speedVariation: t18.speedVariation ?? 0,
      forceScale: t18.speedVariation ?? 0.9,
      add() {
  ...
  function La(t18) {
    return {
      id: "areaEffector",
      require: ["area"],
      useGlobalAngle: t18.useGlobalAngle || false,
      forceAngle: t18.forceAngle,
      forceMagnitude: t18.forceMagnitude,
      forceVariation: t18.forceVariation ?? 0,
      linearDrag: t18.linearDrag ?? 0,
      add() {
        this.onCollideUpdate("body", (e, n) => {
  ...
  function ja(t18) {
    return {
      ...
      forceMagnitude: t18.forceMagnitude,
      forceVariation: t18.forceVariation ?? 0,
      distanceScale: t18.distanceScale ?? 1,
      forceMode: t18.forceMode || "inverseLinear",
      linearDrag: t18.linearDrag ?? 0,
      add() {
        this.onCollideUpdate("body", (e, n) => {
  ...
  function Ka(t18) {
    return {
      id: "platformEffector",
      require: ["area", "body"],
      surfaceArc: t18.surfaceArc ?? 180,
      useOneWay: t18.useOneWay ?? false,
      add() {
  ...
  function ka(t18) {
    return {
      id: "buoyancyEffector",
      require: ["area"],
      surfaceLevel: t18.surfaceLevel,
      density: t18.density ?? 1,
      linearDrag: t18.linearDrag ?? 1,
      angularDrag: t18.angularDrag ?? 0.2,
      flowAngle: t18.flowAngle ?? 0,
      flowMagnitude: t18.flowMagnitude ?? 0,
      flowVariation: t18.flowVariation ?? 0,
      add() {
        this.onCollideUpdate("body", (e, n) => {
          let r = e,
            o = r.worldArea(),
  ...
  function Ha(t18 = {}) {
    let e = false,
      ...
      o = (s) => {
        s.isOffScreen()
          ? (e || (s.trigger("exitView"), e = true),
            t18.hide && (s.hidden = true),
            t18.pause && (s.paused = true),
            t18.destroy && s.destroy())
          : (e && (s.trigger("enterView"), e = false),
            t18.hide && (s.hidden = false),
            t18.pause && (s.paused = false));
      };
    return {
      id: "offscreen",
      require: ["pos"],
      offscreenDistance: t18.distance ?? Gr,
      isOffScreen() {
      ...
      add() {
        t18.pause && t18.unpause
          ? rr(() => o(this))
          : this.onUpdate(() => o(this));
      },
    };
  }
  function Pt(...t18) {
  ...
  var ic = (t18 = { tagsAsComponents: true }) => {
    ...
    o
      ? (n.width = t18.width * r, n.height = t18.height * r)
    ...
    (s.push("image-rendering: pixelated"),
      s.push("image-rendering: crisp-edges")), n.style.cssText = s.join(";");
    ...
    let c = Ms({
      canvas: n,
      touchToMouse: t18.touchToMouse,
      gamepads: t18.gamepads,
      pixelDensity: t18.pixelDensity,
      maxFPS: t18.maxFPS,
      buttons: t18.buttons,
    });
    a.app = c;
    ...
    function O(F, N) {
      ...
      return {
        clear: () => z2.clear(),
        free: () => z2.free(),
        toDataURL: () => z2.toDataURL(),
        toImageData: () => z2.toImageData(),
        width: z2.width,
        height: z2.height,
        draw: (oe) => {
    ...
    function V() {
      ...
      d.width = l.drawingBufferWidth / i,
        ...
        Vt({
          ...
          shader: d.postShader,
          uniform: typeof d.postShaderUniform == "function"
            ? d.postShaderUniform()
            : d.postShaderUniform,
          fixed: true,
        }),
    ...
    let x = false,
      w = {
        ...
        log: (...F) => {
          let N = t18.logMax ?? 8,
            z2 = F.length > 1 ? F.concat(" ").join(" ") : F[0];
          y.logs.unshift({ msg: z2, time: c.time() }),
            y.logs.length > N && (y.logs = y.logs.slice(0, N));
        },
        error: (F) => w.log(new Error(F.toString ? F.toString() : F)),
        curRecording: null,
        numObjects: () => _("*", { recursive: true }).length,
        get paused() {
          return x;
        },
        set paused(F) {
    ...
    function D(F) {
      let N = c.canvas.captureStream(F),
        z2 = C.ctx.createMediaStreamDestination();
    ...
    function yn() {
      ...
      function ye(Q) {
        if (
          oe.push(z2.clone()),
            Q.pos && z2.translate(Q.pos),
            Q.scale && z2.scale(Q.scale),
            Q.angle && z2.rotate(Q.angle),
            Q.transform = z2.clone(),
            Q.c("area") && !Q.paused
        ) {
          let ve = Q,
    ...
    c.run(() => {
      ...
      try {
        F(),
          g.loaded ||
          Be() === 1 && !Mt && (g.loaded = true,
              Un().forEach((z2) => y.events.trigger("loadError", ...z2)),
              y.events.trigger("load")),
          !g.loaded && t18.loadingScreen !== false || Mt
            ? (A(), hi(), V())
            : (w.paused || Gt(),
              yn(),
              A(),
  ...
  function playExplosionEffect(context2) {
    if (GOD_MODE) {
      return;
    }
    const currentX = context2.state.ship.pos.x - 8;
  ...
  function startJump(context2) {
    if (context2.state.limitsBar.value <= 0) {
      return;
    }
    context2.state.hyperfocus = true;
    playJumpAnimation(context2);
  }
  function executeJump(context2) {
  ...
  // src/ts/components/Banner.ts
  function BannerText(context2) {
    const elapsedSeconds = Math.floor(
      (Date.now() - context2.state.startTime) / 1e3,
    );
    return [
  ...
  // src/ts/events.ts
  var MOVE_RATE = 100;
  function bindShipMovement(context2) {
  ...
  function bindJumpInput(context2) {
    onKeyDown("space", () => startJump(context2));
    onMousePress(() => executeJump(context2));
  }
  function bindCursorMovement(context2) {
    onMouseMove(() => {
  ...
  function bindEvents(context2) {
    bindShipMovement(context2);
    bindJumpInput(context2);
    bindCursorMovement(context2);
  }
  ...
  // src/ts/spawn.ts
  function getSpawnPositions(sides) {
  ...
  function spawnToken(context2) {
    const { tokens, ship } = context2.state;
    if (!ship) return;
    const shipX = ship.pos.x;
    const shipY = ship.pos.y;
  ...
  function registerGameScene(context2) {
    scene("game", () => {
      ...
      spawnEnemy(context2, levelConfig, levelConfig.firingParams, sides);
      bindEvents(context2);
  ...
  function registerMenuScene(context2) {
    scene("menu", () => {
      ...
      add([
        text("created in a rush by R\xF3is\xEDn", {
          size: 10,
        }),
  ...
  function register(context2) {
    registerGameScene(context2);
    registerMenuScene(context2);
  }
